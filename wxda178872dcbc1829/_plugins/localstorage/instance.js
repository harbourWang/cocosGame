...
var _default = exports.default = function() {
    function t(e) {
        return _classCallCheck(this, t), (e = _callSuper(this, t, [ e ]))._currentKey = "", 
    ...
    return _inherits(t, LB.SDK.IPluginInstanceBase), _createClass(t, [ {
        ...
        value: function(e) {
            ...
            if (this._runtime.isMiniGame) try {
                t = wx.getStorageSync(this._storageKey);
            } catch (e) {
                this._errorMessage = e.msg, console.log('wx.getStorageSync("'.concat(storage_key, '") catch'));
            } else null === (t = localStorage.getItem(this._storageKey)) && (t = "{}");
            try {
        ...
        value: function(e) {
            if (this._runtime.isMiniGame) try {
                wx.setStorageSync(this._storageKey, e);
            } catch (e) {} else localStorage.setItem(this._storageKey, e);
        }
    } ]);
}();