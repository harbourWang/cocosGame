...
var _default = exports.default = function() {
    function t(e) {
        return _classCallCheck(this, t), (e = _callSuper(this, t, [ e ]))._runtime.isMiniGame && GameGlobal.isPublish ? (wx.showToast({
            title: "发布成独立小游戏暂不支持世界排行榜",
            icon: "none"
        }), _possibleConstructorReturn(e)) : (e._runtime.isMiniGame && wx.cloud.init(), 
        e);
    }
    return _inherits(t, LB.SDK.IPluginBase), _createClass(t, [ {
        key: "release",
        value: function() {
