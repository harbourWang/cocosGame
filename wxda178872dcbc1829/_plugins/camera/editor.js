...
var _default = exports.default = function() {
    ...
    return _inherits(r, PIXI.Container), _createClass(r, [ {
        key: "init",
        value: function(t) {
            var e = t.width, e = void 0 === e ? 100 : e, t = t.full;
            this.wrap = PIXI.Sprite.from("data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"), 
            this.addChild(this.wrap), this.wrap.width = e, this.wrap.height = e / 3 * 4, this.wrap.visible = !t;
        }
    } ]);
}();