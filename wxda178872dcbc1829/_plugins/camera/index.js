...
var _instance = _interopRequireDefault(require("./instance")), _action = _interopRequireDefault(require("./action")), _condition = _interopRequireDefault(require("./condition")), _expression = _interopRequireDefault(require("./expression")), _config = _interopRequireDefault(require("./config")), _cameraEngine = _interopRequireDefault(require("./cameraEngine"));
...
var _default = exports.default = function() {
    function r(e) {
        var t;
        return _classCallCheck(this, r), (t = _callSuper(this, r, [ e ])).cameraEngine = new _cameraEngine.default(e.runtime), 
        t;
    }
    return _inherits(r, LB.SDK.IPluginBase), _createClass(r, [ {
        key: "release",
        value: function() {
            this.cameraEngine.closeCamera(), _get(_getPrototypeOf(r.prototype), "release", this).call(this);
        }
    } ]);
}();
