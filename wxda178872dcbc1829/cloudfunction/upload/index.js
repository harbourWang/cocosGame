...
function _regeneratorRuntime() {
    ...
    function c(t, e, r, n) {
        var o, i, a, c, e = e && e.prototype instanceof g ? e : g, e = Object.create(e.prototype), n = new S(n || []);
        return l(e, "_invoke", {
                ...
                for (a.method = t, a.arg = e; ;) {
                    ...
                    if (r) {
                        r = function t(e, r) {
                            ...
                            r.arg = new TypeError("The iterator does not provide a '" + n + "' method")), v;
    ...
    function m() {}
    function w() {}
    var e = {}, b = (i(e, n, function() {
        return this;
    }), Object.getPrototypeOf), b = b && b(b(k([]))), x = (b && b !== t && s.call(b, n) && (e = b), 
    ...
    return l(x, "constructor", {
    ...
    }, _(L.prototype), i(L.prototype, r, function() {
        return this;
        ...
        reset: function(t) {
            ...
            this.method = "next", this.arg = u, this.tryEntries.forEach(O), !t) for (var e in this) "t" === e.charAt(0) && s.call(this, e) && !isNaN(+e.slice(1)) && (this[e] = u);
        },
        stop: function() {
            this.done = !0;
        ...
        finish: function(t) {
            ...
            for (var e = this.tryEntries.length - 1; 0 <= e; --e) {
                ...
                if (o.tryLoc === t) return "throw" === (r = o.completion).type && (n = r.arg, O(o)), 
                n;
            }
...
var cloud = require("wx-server-sdk"), db = (cloud.init(), cloud.database()), collection = db.collection("worldrank"), _ = db.command, uploadScore = function() {
    var n = _asyncToGenerator(_regeneratorRuntime().mark(function t(e, r, n) {
        var o, i;
        return _regeneratorRuntime().wrap(function(t) {
            for (;;) switch (t.prev = t.next) {
              ...
              case 2:
                return o = e + "_" + n, t.next = 5, collection.where({
                    _id: _.eq(o)
                }).get();

              case 5:
                if ((i = t.sent).data && i.data.length) {
                    if (i.data[0].score >= r) return t.abrupt("return", {
                        errcode: 0,
                        msg: "分数小于历史分数，更新不成功"
                    });
                    t.next = 11;
              ...
              case 11:
                return t.next = 13, collection.doc(o).update({
                    data: {
                        score: r,
              ...
              case 17:
                return t.next = 19, collection.doc(o).set({
                    data: {
                        score: r,
                        game_id: n,
                        openid: e,
...
exports.main = function() {
    var r = _asyncToGenerator(_regeneratorRuntime().mark(function t(e, r) {
        ...
        return _regeneratorRuntime().wrap(function(t) {
            for (;;) switch (t.prev = t.next) {
              case 0:
                return n = e.score, o = e.game_id, a = cloud.getWXContext(), i = a.OPENID, a.APPID, 
                a.UNIONID, t.next = 4, uploadScore(i, n, o);
