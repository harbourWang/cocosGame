...
function _regeneratorRuntime() {
    ...
    function c(t, r, e, n) {
        var o, i, a, c, r = r && r.prototype instanceof g ? r : g, r = Object.create(r.prototype), n = new G(n || []);
        return s(r, "_invoke", {
    ...
    var r = {}, b = (i(r, n, function() {
        return this;
    }), Object.getPrototypeOf), b = b && b(b(S([]))), x = (b && b !== t && f.call(b, n) && (r = b), 
    ...
    var e = _asyncToGenerator(_regeneratorRuntime().mark(function t(r, e) {
        ...
        return _regeneratorRuntime().wrap(function(t) {
            for (;;) switch (t.prev = t.next) {
              ...
              case 2:
                return n = r, t.next = 5, collection.doc(n).set({
                    data: {
                        userinfo: e,
...
exports.main = function() {
    var e = _asyncToGenerator(_regeneratorRuntime().mark(function t(r, e) {
        ...
        return _regeneratorRuntime().wrap(function(t) {
            for (;;) switch (t.prev = t.next) {
              case 0:
                return n = r.data, i = cloud.getWXContext(), o = i.OPENID, i.APPID, i.UNIONID, t.next = 4, 
                uploadUserInfo(o, n);
