...
function _regeneratorRuntime() {
    ...
    var u, a = {}, t = Object.prototype, s = t.hasOwnProperty, f = Object.defineProperty || function(t, e, r) {
        t[e] = r.value;
    ...
    var e = {}, b = (i(e, n, function() {
        return this;
    }), Object.getPrototypeOf), b = b && b(b(G([]))), x = (b && b !== t && s.call(b, n) && (e = b), 
    ...
    var r = _asyncToGenerator(_regeneratorRuntime().mark(function t(e, r) {
        ...
        return _regeneratorRuntime().wrap(function(t) {
            for (;;) switch (t.prev = t.next) {
              ...
              case 2:
                return n = e, r.upload_time = db.serverDate(), t.next = 6, collection.where({
                    _id: n
                }).get();

              case 6:
                if (o = t.sent, console.log(o), 0 < o.data.length) return t.next = 11, collection.doc(n).update({
                    data: r
                });
                t.next = 14;
                break;
              ...
              case 14:
                return t.next = 16, collection.doc(n).set({
                    data: r
                });
...
exports.main = function() {
    var r = _asyncToGenerator(_regeneratorRuntime().mark(function t(e, r) {
        ...
        return _regeneratorRuntime().wrap(function(t) {
            for (;;) switch (t.prev = t.next) {
              case 0:
                return n = e.game_id, o = e.data, i = cloud.getWXContext(), i.OPENID, i.APPID, i.UNIONID, 
                t.next = 4, uploadInfo(n, o);
