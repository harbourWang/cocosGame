...
function _regeneratorRuntime() {
    ...
    var u, a = {}, t = Object.prototype, f = t.hasOwnProperty, l = Object.defineProperty || function(t, r, e) {
        t[r] = e.value;
                ...
                for (a.method = t, a.arg = r; ;) {
                    ...
                    if (e) {
                        e = function t(r, e) {
                            ...
                            e.arg = u), e.delegate = null, d) : o : (e.method = "throw", e.arg = new TypeError("iterator result is not an object"), 
                            e.delegate = null, d);
                        }(e, a);
                        if (e) {
                            if (e === d) continue;
                    ...
                    if ("next" === a.method) a.sent = a._sent = a.arg; else if ("throw" === a.method) {
                        if (c === s) throw c = v, a.arg;
                        a.dispatchException(a.arg);
                    } else "return" === a.method && a.abrupt("return", a.arg);
                    c = y;
                    e = h(o, i, a);
                    if ("normal" === e.type) {
                        if (c = a.done ? v : p, e.arg === d) continue;
                        return {
                            value: e.arg,
                            done: a.done
                        };
                    }
                    "throw" === e.type && (c = v, a.method = "throw", a.arg = e.arg);
                }
            })
        }), r;
    }
    ...
    a.wrap = c;
    var s = "suspendedStart", p = "suspendedYield", y = "executing", v = "completed", d = {};
    function g() {}
    function m() {}
    function w() {}
    var r = {}, b = (i(r, n, function() {
        return this;
    }), Object.getPrototypeOf), b = b && b(b(j([]))), x = (b && b !== t && f.call(b, n) && (r = b), 
    ...
    }, L(_.prototype), i(_.prototype, e, function() {
        return this;
    }), a.AsyncIterator = _, a.async = function(t, r, e, n, o) {
        void 0 === o && (o = Promise);
        var i = new _(c(t, r, e, n), o);
        return a.isGeneratorFunction(r) ? i : i.next().then(function(t) {
            return t.done ? t.value : i.next();
        });
    }, L(x), i(x, o, "Generator"), i(x, n, function() {
        return this;
    ...
    var e = _asyncToGenerator(_regeneratorRuntime().mark(function t(r, e) {
        ...
        return _regeneratorRuntime().wrap(function(t) {
            for (;;) switch (t.prev = t.next) {
              case 0:
                return n = cloud.getWXContext(), t.abrupt("return", {
                    event: r,
                    openid: n.OPENID,
                    appid: n.APPID,
                    unionid: n.UNIONID
