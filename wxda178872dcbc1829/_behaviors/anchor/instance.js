...
var _default = exports.default = function() {
    function r(e, t) {
        return _classCallCheck(this, r), (e = _callSuper(this, r, [ e ]))._onTime = t.onTime || 0, 
        e._offTime = t.offTime || 0, e._stage = 1, e._stageTimeLeft = e._offTime || 0, e._allTime = e._timeLeft = t.allTime || 0, 
        e._isFlashing = !1, t && t.enable && e._startTicking(), e;
    }
    return _inherits(r, LB.SDK.IBehaviorInstanceBase), _createClass(r, [ {
        ...
        key: "tick",
        value: function(e) {
            0 < this._timeLeft ? (this._timeLeft -= e, this._timeLeft <= 0 ? (this._timeLeft = 0, 
            this._instance.renderer.visible = !0) : (this._stageTimeLeft -= e, this._stageTimeLeft <= 0 && (0 === this._stage ? (this._instance.renderer.visible = !1, 
            this._stage = 1, this._stageTimeLeft += this._offTime) : (this._instance.renderer.visible = !0, 
            this._stage = 0, this._stageTimeLeft += this._onTime))), this._isFlashing = !0) : this._isFlashing = !1;
        }
    } ]);
}();