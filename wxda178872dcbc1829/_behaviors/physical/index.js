...
var _instance = _interopRequireDefault(require("./instance")), _action = _interopRequireDefault(require("./action")), _condition = _interopRequireDefault(require("./condition")), _expression = _interopRequireDefault(require("./expression")), _index = _interopRequireDefault(require("./engine/index")), _config = _interopRequireDefault(require("./config"));
...
var _default = exports.default = function() {
    function t(e) {
        return _classCallCheck(this, t), (e = _callSuper(this, t, [ e ]))._lastUpdateTick = -1, 
        e.initPhysical(), e;
    }
    return _inherits(t, LB.SDK.IBehaviorBase), _createClass(t, [ {
        key: "initPhysical",
        value: function() {
            var e = this._runtime.renderer, t = {
                height: e.stageInfo.height,
                fps: 60,
                width: e.stageInfo.width,
                deps: e
            };
            this.physicsSystem = _index.default.getInstance(t, e.stage.scale, this._runtime), 
            this._runtime._physicsSystem = this.physicsSystem;
        }
    }, {
        key: "clear",
        value: function() {
        ...
        key: "release",
        value: function() {
            this.physicsSystem.clear(), this.physicsSystem.release(), _get(_getPrototypeOf(t.prototype), "release", this).call(this);
        }
    }, {
        key: "lastUpdateTick",
        get: function() {
        ...
        set: function(e) {
            this._lastUpdateTick = e;
        }
    } ]);
}();

_defineProperty(_default, "Config", _config.default), _defineProperty(_default, "Instance", _instance.default), 
